...
const ApiKeyGate: React.FC<{ onAuthorized: () => void }> = ({ onAuthorized }) => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-6">
            <Card className="max-w-md w-full text-center space-y-6 border-brand-green/30 shadow-2xl bg-brand-dark/95 backdrop-blur-xl">
...
const AppContent: React.FC = () => {
  ...
  return (
    <BaggageDataProvider>
      <div className="min-h-screen font-sans flex flex-col text-gray-200">
