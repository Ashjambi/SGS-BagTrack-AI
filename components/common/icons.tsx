...
export const StatusIcon: React.FC<{ status: any, className?: string }> = ({ className }) => (
  <IconWrapper className={className}>
...
export const CpuChipIcon: React.FC<{ className?: string }> = ({ className }) => (
  <IconWrapper className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 3v1.5M4.5 8.25H3m1.5 7.5H3m7.5 3.75V21m7.5-3.75H21m-1.5-7.5H21M6.75 6.75h10.5v10.5H6.75V6.75Zm1.875 1.875v6.75h6.75v-6.75h-6.75Z" />
  </IconWrapper>
);

export const PresentationChartIcon: React.FC<{ className?: string }> = ({ className }) => (
  <IconWrapper className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3v11.25A2.25 2.25 0 0 0 6 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0 1 18 16.5h-2.25m-7.5 0h7.5m-7.5 0-1.5 1.5M12 10.5l1.5 1.5m0 0L16.5 9m-4.5 4.5L9 10.5m-1.5 6 1.5-1.5" />
  </IconWrapper>
);
